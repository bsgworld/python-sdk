...
class StoplistSearchMeta(BaseModel):
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "search": StoplistSearchCriteria.from_dict(obj["search"]) if obj.get("search") is not None else None
        })
        return _obj
