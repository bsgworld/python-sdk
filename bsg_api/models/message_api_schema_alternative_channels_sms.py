...
class MessageApiSchemaAlternativeChannelsSms(BaseModel):
    """
    MessageApiSchemaAlternativeChannelsSms
    """ # noqa: E501
    sms: Optional[MessageApiSchemaAlternativeChannelsSmsDetails] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "sms": MessageApiSchemaAlternativeChannelsSmsDetails.from_dict(obj["sms"]) if obj.get("sms") is not None else None
        })
        return _obj
