# bsg_api.RcsSingleApi

All URIs are relative to *https://one-api.bsg.world*

| Method | HTTP request | Description |
| ------ | ------------ | ----------- |
| [**rcs_single**](RcsSingleApi.md#rcs_single) | **POST** /api/messages/rcs/send | Send single RCS message |
...
with bsg_api.ApiClient(configuration) as api_client:
    ...
    api_instance = bsg_api.RcsSingleApi(api_client)
    ...
    try:
        ...
        print("The response of RcsSingleApi->rcs_single:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling RcsSingleApi->rcs_single: %s\n" % e)
```
