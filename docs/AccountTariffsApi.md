# bsg_api.AccountTariffsApi

All URIs are relative to *https://one-api.bsg.world*

| Method | HTTP request | Description |
| ------ | ------------ | ----------- |
| [**account_tariffs**](AccountTariffsApi.md#account_tariffs) | **GET** /api/accounts/tariff | Get tariffs |
...
with bsg_api.ApiClient(configuration) as api_client:
    ...
    api_instance = bsg_api.AccountTariffsApi(api_client)
    ...
    try:
        ...
        print("The response of AccountTariffsApi->account_tariffs:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling AccountTariffsApi->account_tariffs: %s\n" % e)
```
