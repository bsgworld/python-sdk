# bsg_api.PostCampaignsWhatsappSendApi

All URIs are relative to *https://one-api.bsg.world*

| Method | HTTP request | Description |
| ------ | ------------ | ----------- |
| [**post_campaigns_whatsapp_send**](PostCampaignsWhatsappSendApi.md#post_campaigns_whatsapp_send) | **POST** /api/campaigns/whatsapp/send | Send WhatsApp campaign |
...
with bsg_api.ApiClient(configuration) as api_client:
    ...
    api_instance = bsg_api.PostCampaignsWhatsappSendApi(api_client)
    ...
    try:
        ...
        print("The response of PostCampaignsWhatsappSendApi->post_campaigns_whatsapp_send:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling PostCampaignsWhatsappSendApi->post_campaigns_whatsapp_send: %s\n" % e)
```
