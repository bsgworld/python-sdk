# bsg_api.CampaignStopApi

All URIs are relative to *https://one-api.bsg.world*

| Method | HTTP request | Description |
| ------ | ------------ | ----------- |
| [**campaign_stop**](CampaignStopApi.md#campaign_stop) | **PATCH** /api/campaigns/{id}/stop | Cancel campaign |
...
with bsg_api.ApiClient(configuration) as api_client:
    ...
    api_instance = bsg_api.CampaignStopApi(api_client)
    id = 56 # int | 

    try:
        # Cancel campaign
        api_response = api_instance.campaign_stop(id)
        print("The response of CampaignStopApi->campaign_stop:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling CampaignStopApi->campaign_stop: %s\n" % e)
```
