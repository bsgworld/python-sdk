# bsg_api.GetMessagesApi

All URIs are relative to *https://one-api.bsg.world*

| Method | HTTP request | Description |
| ------ | ------------ | ----------- |
| [**get_messages**](GetMessagesApi.md#get_messages) | **GET** /api/messages | Find messages |
...
with bsg_api.ApiClient(configuration) as api_client:
    ...
    api_instance = bsg_api.GetMessagesApi(api_client)
    ...
    try:
        ...
        print("The response of GetMessagesApi->get_messages:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling GetMessagesApi->get_messages: %s\n" % e)
```
