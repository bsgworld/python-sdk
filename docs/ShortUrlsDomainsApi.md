# bsg_api.ShortUrlsDomainsApi

All URIs are relative to *https://one-api.bsg.world*

| Method | HTTP request | Description |
| ------ | ------------ | ----------- |
| [**short_urls_domains**](ShortUrlsDomainsApi.md#short_urls_domains) | **GET** /api/short-url/domains | List of domains |
...
with bsg_api.ApiClient(configuration) as api_client:
    ...
    api_instance = bsg_api.ShortUrlsDomainsApi(api_client)
    ...
    try:
        ...
        print("The response of ShortUrlsDomainsApi->short_urls_domains:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling ShortUrlsDomainsApi->short_urls_domains: %s\n" % e)
```
