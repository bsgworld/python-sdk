# bsg_api.EmailSendApi

All URIs are relative to *https://one-api.bsg.world*

| Method | HTTP request | Description |
| ------ | ------------ | ----------- |
| [**email_send**](EmailSendApi.md#email_send) | **POST** /api/email/send-emails | Send Email |
...
with bsg_api.ApiClient(configuration) as api_client:
    ...
    api_instance = bsg_api.EmailSendApi(api_client)
    ...
    try:
        ...
        print("The response of EmailSendApi->email_send:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling EmailSendApi->email_send: %s\n" % e)
```
