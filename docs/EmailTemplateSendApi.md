# bsg_api.EmailTemplateSendApi

All URIs are relative to *https://one-api.bsg.world*

| Method | HTTP request | Description |
| ------ | ------------ | ----------- |
| [**email_template_send**](EmailTemplateSendApi.md#email_template_send) | **POST** /api/email/send-template-emails | Send Email template |
...
with bsg_api.ApiClient(configuration) as api_client:
    ...
    api_instance = bsg_api.EmailTemplateSendApi(api_client)
    ...
    try:
        ...
        print("The response of EmailTemplateSendApi->email_template_send:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling EmailTemplateSendApi->email_template_send: %s\n" % e)
```
